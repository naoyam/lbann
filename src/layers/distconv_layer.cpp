...
distconv_layer::distconv_layer(Layer &layer)
    : m_layer(layer) {
}

Layer& distconv_layer::layer() { return m_layer; }
const Layer& distconv_layer::layer() const { return m_layer; }

std::string distconv_layer::get_name() const {
